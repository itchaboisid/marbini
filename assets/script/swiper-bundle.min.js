...
var swiper = new Swiper('.swiper-container', {
    ...
    on: {
      slideChangeTransitionStart: function () {
        ...
        // Find the .image-data element within the active slide
        var imageData = activeSlide.querySelector('.image-data');
        // Add animation class to trigger the animation
        imageData.classList.add('animate-slide');
      },
      slideChangeTransitionEnd: function () {
        ...
        imageData.addEventListener('animationend', function() {
          imageData.classList.remove('animate-slide');
